  ...
  return (
    <section className="bg-white-gradient-to-b from-white to-[#e8f2f5] text-center py-28 px-4 bg-white dark:bg-slate-900">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-extrabold text-teal-50 dark:text-teal-100 leading-tight">
        ...
        <button className="mt-10 px-10 py-4 bg-orange-500 hover:bg-orange-600 text-teal-50 dark:text-teal-100 font-semibold rounded-full shadow-lg transition duration-300">
          Get Started
        </button>
      </div>
    </section>
